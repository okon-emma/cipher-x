...
for file in os.listdir(directory):
    ...
    f.write("home,score,away,result,home_odd,draw_odd,away_odd\n")
...
################################################################
                ...
                f.write(home + "," + score + "," + away + "," + result(score) + "," +  hodd(s_home,s_away) + "," + dodd(s_home,s_away) + "," + aodd(s_home,s_away) + "\n")
